...
func (s *server) Check(
	...
	if strings.Contains(authorization, "deny me") {
		log.Println("Request rejected because it has the rejection header")
	...
	log.Println("Received request and authorized by default")
	return &envoy_service_auth_v3.CheckResponse{
				...
				Headers: []*envoy_api_v3_core.HeaderValueOption{
					{
						...
						Header: &envoy_api_v3_core.HeaderValue{
							...
							Key:   "x-random-value",
							Value: fmt.Sprint(rand.Intn(100)),
						},
					},
				},
			},
